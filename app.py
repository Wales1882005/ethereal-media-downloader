    ...
    if url:
        with st.spinner("Weaving the magic... this might take a moment!"):
            ...
            try:
                ...
                # Hand the file to the Web Browser!
        ...
        st.warning("Please enter a valid URL first.")import streamlit as st
import yt_dlp
import os
        ...
        with st.spinner("Weaving the magic... this might take a moment!"):
            ...
            if "Audio" in format_choice:
                ydl_opts = {
                    'format': 'ba[ext=m4a]',
                    'outtmpl': temp_file, 
                    'cookiesfrombrowser': ('chrome', ) # <--- Add this line! Change 'chrome' to 'edge' if you use Microsoft Edge
                }
            else:
                ydl_opts = {
                    'format': 'bv*[ext=mp4]+ba[ext=m4a]/b[ext=mp4]/best',
                    'outtmpl': temp_file,
                    'cookiesfrombrowser': ('chrome', ) # <--- Add this line here too!
                }
